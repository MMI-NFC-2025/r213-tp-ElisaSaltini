...
const $$prix = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const offres = (await getOffres()).filter((o) => Number(o.prix) < maxPrix);
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "titre": `Prix < ${maxPrix} \u20AC` }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="px-4 py-6"> <h1 class="text-4xl font-bold text-gray-900 mt-2 mb-4">
Maisons à moins de ${maxPrix} €
...
}, "C:/Users/elisa/Documents/MMI1 Elisa/Semestre 1/R/r213-tp-ElisaSaltini/src/pages/offres/prix/[prix].astro", void 0);

const $$file = "C:/Users/elisa/Documents/MMI1 Elisa/Semestre 1/R/r213-tp-ElisaSaltini/src/pages/offres/prix/[prix].astro";
